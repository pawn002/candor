...
- **Design Tokens** — Color palette, spacing scale
- **Typography** — Heading hierarchy, body text, accessible text (Atkinson Hyperlegible), article layout
- **Components/Button** — Primary, secondary, tertiary, ghost variants
- **Components/Form** — Input, checkbox, radio
- **Components/Accordion** — Native `<details>`/`<summary>` with CSS grid height animation
...
- **Components/Table** — Full and compact key/value variants with zebra striping
