...
export const Default: Story = {
  args: { heading: 'Dialog title', size: 'md' },
  render: (args) => ({
    ...
    template: `
      ...
      <app-modal [open]="isOpen" [heading]="heading" [size]="size" (closed)="isOpen = false">
        ...
        <div slot="footer" class="modal__footer">
          ...
          <app-button variant="primary" (clicked)="isOpen = false">Confirm</app-button>
        </div>
      </app-modal>
    `,
  }),
...
export const Small: Story = {
  ...
  render: (args) => ({
    props: { ...args, isOpen: false },
    template: `
      <app-button variant="secondary" (clicked)="isOpen = true">Open small modal</app-button>
      <app-modal [open]="isOpen" [heading]="heading" [size]="size" (closed)="isOpen = false">
        <p>Are you sure you want to delete this item? This action cannot be undone.</p>
        <div slot="footer" class="modal__footer">
          <app-button variant="tertiary" (clicked)="isOpen = false">Cancel</app-button>
          <app-button variant="secondary" (clicked)="isOpen = false">Delete</app-button>
        </div>
      </app-modal>
    `,
  }),
...
export const Large: Story = {
  ...
  render: (args) => ({
    props: { ...args, isOpen: false },
    template: `
      <app-button variant="primary" (clicked)="isOpen = true">Open large modal</app-button>
      <app-modal [open]="isOpen" [heading]="heading" [size]="size" (closed)="isOpen = false">
        ...
        <div slot="footer" class="modal__footer">
          <app-button variant="tertiary" (clicked)="isOpen = false">Decline</app-button>
          <app-button variant="primary" (clicked)="isOpen = false">Accept</app-button>
        </div>
      </app-modal>
    `,
  }),
...
export const NoFooter: Story = {
  ...
  render: (args) => ({
    props: { ...args, isOpen: false },
    template: `
      <app-button variant="tertiary" (clicked)="isOpen = true">Open keyboard shortcuts</app-button>
      <app-modal [open]="isOpen" [heading]="heading" [size]="size" (closed)="isOpen = false">
