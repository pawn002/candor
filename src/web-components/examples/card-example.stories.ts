...
export const ProfileCard: Story = {
  render: () => html`
      <style>
        ...
        @media (max-width: 400px) {
          ...
          .profile-card-actions {
            --spacing-button-padding-x: var(--spacing-sm);
            --spacing-button-padding-y: var(--spacing-xs);
          }
        }
      </style>
      <div style="padding: 1rem; max-width: 100%;"><candor-card variant="outlined" padding="lg" style="max-width: 300px; text-align: center;">
        ...
        <div class="profile-stats" style="display: flex; justify-content: center; margin-bottom: 1.5rem; padding: 1rem 0; border-top: 1px solid var(--color-border-default); border-bottom: 1px solid var(--color-border-default);">
