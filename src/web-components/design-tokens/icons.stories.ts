    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: var(--spacing-md); max-width: 480px;">
        ...
        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
          ...
          <pre style="font-family: var(--font-family-mono); font-size: 0.75rem; background: var(--color-bg-surface); padding: 0.5rem; border-radius: var(--radius-sm); margin: 0;">&lt;candor-button variant="primary"&gt;
...
&lt;/candor-button&gt;</pre>
        ...
        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
          <p style="font-family: var(--font-family-mono); font-size: 0.75rem; color: var(--color-text-subtle); margin: 0;">Pattern B — icon-only (aria-label attribute)</p>
          <candor-button variant="ghost" aria-label="Notifications">
            <i class="ph-fill ph-bell" style="font-size: 1.25rem; line-height: 1;" aria-hidden="true"></i>
          </candor-button>
          <pre style="font-family: var(--font-family-mono); font-size: 0.75rem; background: var(--color-bg-surface); padding: 0.5rem; border-radius: var(--radius-sm); margin: 0;">&lt;candor-button variant="ghost" aria-label="Notifications"&gt;
