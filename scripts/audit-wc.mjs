...
const PAIRS = [
  ...
  ['progress',       'components-progress--all-bar-states',              'web-components-progress--default'],
  ['button',         'components-button--all-variants',                  'web-components-button--all-variants'],
  ['chip',           'components-chip--all-variants',                    'web-components-chip--default'],
  ...
  ['input',          'components-form-input--all-states',                'web-components-form-input--default'],
  ...
  ['select',         'components-form-select--all-states',               'web-components-form-select--default'],
  ['slider',         'components-form-slider--all-variants',             'web-components-form-slider--default'],
